...
public class Truck extends Car {
    ...
    public Truck(String model, double maxSpeed, int averageBrakingDistance, int yearOfProduction) {
    ...
    @Override
    public void stop() {
        System.out.println("Average braking distance of this truck is " + (int) getAverageBrakingDistance() + " m.");
    }
}
