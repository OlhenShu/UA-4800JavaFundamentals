...
public class Employee {
    ...
    public Employee(String name, double salary) {
        if(name.isEmpty() || salary < 0) {
            throw new IllegalArgumentException("Name cannot be empty and salary cannot be negative.");
        }
        this.name = name;
        this.salary = salary;
    }
    ...
    public static void main(String[] args) {
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            System.out.println("Invalid input. Please enter an integer for department number.");
        }
    }
